...
public class SitterController {
    ...
    public ResponseEntity<?> enroll(@PathVariable("id") Long walkId, UsernamePasswordAuthenticationToken token) {
    ...
    public ResponseEntity<?> disenroll(@PathVariable("id") Long walkId, UsernamePasswordAuthenticationToken token) {
